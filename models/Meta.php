...
class Meta extends \yii\db\ActiveRecord
{
     ...
     * @return array
     */
    public static function getItems(\yii\db\ActiveRecord $activeRecord, $tenantId = null)
    {
        $items = [];
     ...
     */
    public static function saveValues(\yii\db\ActiveRecord $activeRecord, \yii\base\DynamicModel $dynamicModel, $tenantId = null, $throwException = false)
    {
        try {
