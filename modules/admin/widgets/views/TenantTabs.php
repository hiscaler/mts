...
<div class="clearfix">
    ...
    <div class="panels">
        <div id="panel-tenant-detail" class="tenant-view tab-pane" style="<?= $tab == 'detail' ? '' : 'display: none' ?>">
        ...
        <div id="panel-tenant-modules" class="tenant-view tab-pane" style="<?= $tab == 'modules' ? '' : 'display: none' ?>">
            <div class="clearfix">
        ...
        <div id="panel-tenant-access-tokens" class="tenant-view tab-pane" style="<?= $tab == 'access-tokens' ? '' : 'display: none' ?>">
            <div class="grid-view clearfix">
